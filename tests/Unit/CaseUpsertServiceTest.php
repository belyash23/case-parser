...
class CaseUpsertServiceTest extends TestCase
{
    ...
    private function parsedCase(string $receivedDate, ?string $completedAt): ParsedCaseInstance
    {
        return new ParsedCaseInstance(
            ...
            normalizedCaseNumberAliases: ['2-100/2025'],
            caseUid: 'uid-100',
            externalCaseId: '100',
            sourceCaseTypeId: '1540005',
            caseType: 'civil',
            instanceLevel: 'first',
            courtInstanceStatusRaw: $completedAt !== null ? 'closed' : 'active',
            courtInstanceStatusNormalized: $completedAt !== null ? 'closed' : 'active',
            disputeStatusNormalized: $completedAt !== null ? 'resolved' : 'active',
            dispositionType: $completedAt !== null ? 'satisfied' : null,
            resultRaw: $completedAt !== null ? 'satisfied' : null,
            resultNormalized: $completedAt !== null ? 'satisfied' : null,
